        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (i = 0; i < dataRow; i++) {
                ...
                response.getWriter().write("<tr>"
                        ...
                        + "<td>"+ documentId[i] +"</td>"
                        + "<td>"+ shortDesc[i] +"</td>"
                        + "<td><a href='../uplopded_file/"+ scanFile[i] +"'  alt='' height='40px' width='40px'></a></td>"
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servlet AllNewDocument</title>");
                out.println("</head>");
                out.println("<body>");
                out.println("<h1>Servlet AllNewDocument at " + request.getContextPath() + "</h1>");
                out.println("</body>");
                out.println("</html>");

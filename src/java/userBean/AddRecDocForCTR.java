...
public class AddRecDocForCTR extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            goingToUserId = new String(request.getParameter("goingToCTR").getBytes("ISO-8859-1"), "UTF-8");
            ...
            Logger.getLogger(AddRecDocForCTR.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
